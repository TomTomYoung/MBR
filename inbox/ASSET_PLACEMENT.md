...
2026-09-21更新。全41地点の背景PNGと音47点（OGGとWAV原本各47点）を配置済みです。追加背景の受領37点は採用33点・旧版4点に整理し、inboxの未整理画像はありません。旧版4点と採用画像の受領破損データはassets/source/20260920-backgrounds配下に保管しています。以下の過去記録は各作業時点の状態です。
...
## 2026-09-21 中央管理室から南門までの6枚を配置

中央管理室（management）：inbox/ChatGPT Image 2026年9月21日 05_35_05 (29).png → assets/scenes/management.png。管理卓・資料・内扉を確認しました。正常画像から復旧。破損した受領データはassets/source/20260920-backgrounds/corrupt/management.binへ保管。

非常階段（stairs）：inbox/ChatGPT Image 2026年9月21日 05_35_07 (35).png → assets/scenes/stairs.png。階段・開いた扉・鍵付きノブを確認しました。正常な受領原本をそのまま移動。

中央機構室（mechanism）：inbox/ChatGPT Image 2026年9月21日 05_35_06 (31).png → assets/scenes/mechanism.png。可動隔壁・停止位置の目盛り・操作部・床と隔壁の擦り跡を確認しました。正常画像から復旧。破損した受領データはassets/source/20260920-backgrounds/corrupt/mechanism.binへ保管。

非常通信室（comms）：inbox/ChatGPT Image 2026年9月21日 05_35_06 (32).png → assets/scenes/comms.png。校外への回線・送信装置・表示部・下書きを確認しました。正常画像から復旧。破損した受領データはassets/source/20260920-backgrounds/corrupt/comms.binへ保管。

最終報告室（terminal）：inbox/ChatGPT Image 2026年9月21日 05_35_08 (37).png → assets/scenes/terminal.png。戸口・室内・提出端末・印字部を確認しました。正常な受領原本をそのまま移動。

南門（south）：inbox/ChatGPT Image 2026年9月21日 05_35_07 (34).png → assets/scenes/south.png。門・背後の貯水塔・表示用の看板を確認しました。正常な受領原本をそのまま移動。

中央管理室・中央機構室・非常通信室の3枚は、正常画像をUTF-8の置換付きで復号し、CRLFをLFへ正規化して再度UTF-8で符号化すると、破損した受領データとバイト単位で完全一致しました。この一致を照合根拠として正常画像を採用し、6枚すべてのPNG読込を確認しました。非常階段・最終報告室・南門は受領原本と配置画像のGit blobが一致しています。中央管理室は1672×940、ほか5枚は1672×941で、原寸を維持しています。

破損データは拡張子.binで保管し、manifestに受領名・正常画像のSHA256・受領blob・復旧blob・保管先・照合方法を記録しました。既存のPNG優先読込により全41地点がPNG表示になります。追加33地点のうち13枚は正常画像から復旧済みです。不足一覧から最後の6地点を除外し、pending_imagesを空にしました。今回の画像処理は6枚で終了しています。

### 次回照合するinboxの残り4枚

inbox/ChatGPT Image 2026年9月21日 05_35_00 (15).png

inbox/ChatGPT Image 2026年9月21日 05_35_03 (27).png

inbox/ChatGPT Image 2026年9月21日 05_35_05 (30).png

inbox/ChatGPT Image 2026年9月21日 05_35_06 (33).png

上記4枚は今回移動・削除していません。採用済み背景との対応と保管先を確認してから整理します。

## 2026-09-21 inboxに残っていた旧版4枚の整理完了

装備点検室の旧版：inbox/ChatGPT Image 2026年9月21日 05_35_00 (15).png → assets/source/20260920-backgrounds/superseded/equipment-before-fix.png。扉上の部屋名札を空欄にした修正版を採用。正常なPNG原本をそのまま保管。

避難所の旧版：inbox/ChatGPT Image 2026年9月21日 05_35_03 (27).png → assets/source/20260920-backgrounds/corrupt/shelter-before-fix.bin。計数器の数字を空欄にした修正版を採用。破損した受領データを.binとしてそのまま保管。

非常階段の旧版：inbox/ChatGPT Image 2026年9月21日 05_35_05 (30).png → assets/source/20260920-backgrounds/corrupt/stairs-before-fix.bin。扉の金物を修正した版を採用。破損した受領データを.binとしてそのまま保管。

最終報告室の旧版：inbox/ChatGPT Image 2026年9月21日 05_35_06 (33).png → assets/source/20260920-backgrounds/corrupt/terminal-before-fix.bin。端末の数字表示を空欄にした修正版を採用。破損した受領データを.binとしてそのまま保管。

装備点検室は正常な生成原本と受領PNGがバイト単位で一致しました。避難所・非常階段・最終報告室の3点は、正常な旧版原本をUTF-8の置換付きで復号し、CRLFをLFへ正規化して再度UTF-8で符号化すると、破損した受領データと完全一致しました。旧版原本の内容を採用済みの修正版と照合して対応を確認しています。

4点とも受領ファイルと保管先で同じGit blobを使用し、元データを保持しています。manifestのarchiveに受領名・保管先・採用画像・SHA256・識別方法・旧版とした理由を記録しました。採用中の41点とPNG読込参照は維持し、今回の処理は旧版4点だけです。inboxの画像整理は完了しました。
