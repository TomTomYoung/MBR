...
2026-09-21更新。中央管理室・非常階段・中央機構室・非常通信室・最終報告室・南門の背景6点を追加し、全41地点の背景PNGと音47点（OGGとWAV原本各47点）を配置済みです。追加背景33地点の未配置は解消しました。inboxには今回未処理の別画像4枚が残っています。以下の過去記録は各作業時点の状態です。
